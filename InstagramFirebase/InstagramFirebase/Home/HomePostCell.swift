...
class HomePostCell: UICollectionViewCell {
    ...
    fileprivate func setupAttributedCaption() {
        ...
        attributedText.append(NSAttributedString(string: timeAgoDisplay,  attributes: [NSAttributedStringKey.foregroundColor: UIColor.gray, NSAttributedStringKey.font: UIFont.systemFont(ofSize: 14)]))
