...
//        button.addTarget(self, action: #selector(handleSignUp), for: .touchUpInside)
    ...
    override func viewDidLoad() {
        ...
        dontHaveAccountButton.anchor(top: nil, left: view.leftAnchor, bottom: view.bottomAnchor, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 100)
